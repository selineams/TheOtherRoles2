...
namespace TheOtherRoles {
    public class CustomOptionHolder {
        ...
        public static string[] presets = new string[]{Helpers.transl("preset1"), Helpers.transl("preset2"), Helpers.transl("preset3"), Helpers.transl("preset4"), Helpers.transl("preset5")};
        ...
        public static void Load() {
            ...
            activateRoles = CustomOption.Create(1, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), Helpers.transl("blockOriginal")), true, null, true);
            ...
            impostorRolesCountMin = CustomOption.Create(304, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), Helpers.transl("impostorRolesCountMin")), 15f, 0f, 3f, 1f);
            impostorRolesCountMax = CustomOption.Create(305, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), Helpers.transl("impostorRolesCountMax")), 15f, 0f, 3f, 1f);
            ...
            mafiaSpawnRate = CustomOption.Create(10, Types.Impostor, cs(Janitor.color, Helpers.transl(Helpers.transl("mafia"))), rates, null, true);
