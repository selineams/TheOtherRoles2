...
/// What do? Add in code to account for vet alert for ALL buttons. Here I need to add a check for ReverseKill
			...
			MurderAttemptResult checkReverseKill = Helpers.checkMuderAttemptAndKill(Sheriff.currentTarget, Sheriff.sheriff);
                ...
                () => { showTargetNameOnButton(Sheriff.currentTarget, sheriffKillButton, "KILL"); return Sheriff.currentTarget && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
                () => { sheriffKillButton.Timer = sheriffKillButton.MaxTimer;},
            ...
            medicShieldButton = new CustomButton(
                ...
                () => { showTargetNameOnButton(Medic.currentTarget, medicShieldButton, ""); return !Medic.usedShield && Medic.currentTarget && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
                () => {},
            ...
            shifterShiftButton = new CustomButton(
                ...
                () => { showTargetNameOnButton(Shifter.currentTarget, shifterShiftButton, ""); return Shifter.currentTarget && Shifter.futureShift == null && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
                () => { },
            ...
            morphlingButton = new CustomButton(
                ...
                () => { showTargetNameOnButton(Morphling.currentTarget, morphlingButton, ""); return (Morphling.currentTarget || Morphling.sampledTarget) && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
                () => { 
            ...
            trackerTrackPlayerButton = new CustomButton(
                ...
                () => { showTargetNameOnButton(Tracker.currentTarget, trackerTrackPlayerButton, ""); return CachedPlayer.LocalPlayer.PlayerControl.CanMove && Tracker.currentTarget != null && !Tracker.usedTracker; },
            ...
            jackalSidekickButton = new CustomButton(
                ...
                () => { showTargetNameOnButton(Jackal.currentTarget, jackalSidekickButton, ""); return Jackal.canCreateSidekick && Jackal.currentTarget != null && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
            ...
            jackalKillButton = new CustomButton(
                ...
                () => { showTargetNameOnButton(Jackal.currentTarget, jackalKillButton, "KILL"); return Jackal.currentTarget && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
                () => { jackalKillButton.Timer = jackalKillButton.MaxTimer;},
                __instance.KillButton.graphic.sprite,
                new Vector3(0, 1f, 0),
                __instance,
            ...
            sidekickKillButton = new CustomButton(
                ...
                () => { showTargetNameOnButton(Sidekick.currentTarget, sidekickKillButton, "KILL"); return Sidekick.currentTarget && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
                () => { sidekickKillButton.Timer = sidekickKillButton.MaxTimer;},
                __instance.KillButton.graphic.sprite,
                new Vector3(0, 1f, 0),
                __instance,
            ...
            eraserButton = new CustomButton(
                ...
                () => { showTargetNameOnButton(Eraser.currentTarget, eraserButton, ""); return CachedPlayer.LocalPlayer.PlayerControl.CanMove && Eraser.currentTarget != null; },
                () => { eraserButton.Timer = eraserButton.MaxTimer;},
            ...
            warlockCurseButton = new CustomButton(
                ...
                () => { showTargetNameOnButton(Warlock.currentTarget, warlockCurseButton, ""); return ((Warlock.curseVictim == null && Warlock.currentTarget != null) || (Warlock.curseVictim != null && Warlock.curseVictimTarget != null)) && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
                () => { 
            ...
            swooperKillButton = new CustomButton(
                ...
                () => { showTargetNameOnButton(Swooper.currentTarget, swooperKillButton, "KILL"); return Jackal.currentTarget && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
                () => { swooperKillButton.Timer = swooperKillButton.MaxTimer;},
                __instance.KillButton.graphic.sprite,
                new Vector3(0, 1f, 0),
                __instance,
