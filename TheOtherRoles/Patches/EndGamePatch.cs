    ...
    public class OnGameEndPatch {
        ...
        public static void Postfix(AmongUsClient __instance, [HarmonyArgument(0)]ref EndGameResult endGameResult) {
            ...
            // Akujo win
                ...
                EndGameResult.CachedWinners = new Il2CppSystem.Collections.Generic.List<CachedPlayerData>();
                CachedPlayerData wpd = new CachedPlayerData(Cerenovus.cerenovus.Data);
                EndGameResult.CachedWinners.Add(wpd);
                AdditionalTempData.winCondition = WinCondition.CerenovusWin;

                if (Cerenovus.formerCerenovus != null)
                {
                    CachedPlayerData wpdFormerCerenovus = new CachedPlayerData(Cerenovus.formerCerenovus.Data);
                    EndGameResult.CachedWinners.Add(wpdFormerCerenovus);
                }
            }
