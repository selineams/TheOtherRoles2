...
namespace TheOtherRoles
{
    class RoleInfo {
        ...
        public static RoleInfo godfather = new RoleInfo(Helpers.transl("godfather"), Godfather.color, Helpers.transl("godfatherIntroDesc"), Helpers.transl("godfatherIntroDesc"), RoleId.Godfather);
        public static RoleInfo mafioso = new RoleInfo(Helpers.transl("mafioso"), Mafioso.color, Helpers.transl("mafiosoIntroDesc"), Helpers.transl("godfatherIntroDesc"), RoleId.Mafioso);
        public static RoleInfo janitor = new RoleInfo(Helpers.transl("janitor"), Janitor.color, Helpers.transl("janitorIntroDesc"), "Hide dead bodies", RoleId.Janitor);
        public static RoleInfo morphling = new RoleInfo(Helpers.transl("morphling"), Morphling.color, Helpers.transl("morphlingIntroDesc"), Helpers.transl("morphlingShortDesc"), RoleId.Morphling);
        public static RoleInfo bomber = new RoleInfo("Bomber", Bomber.color, "Give bombs to players", "Bomb Everyone", RoleId.Bomber);
        public static RoleInfo camouflager = new RoleInfo(Helpers.transl("camouflager"), Camouflager.color, Helpers.transl("camouflagerIntroDesc"), Helpers.transl("camouflagerShortDesc"), RoleId.Camouflager);
        public static RoleInfo miner = new RoleInfo("Miner", Miner.color, "Make new Vents", "Create Vents", RoleId.Miner);
        public static RoleInfo vampire = new RoleInfo(Helpers.transl("vampire"), Vampire.color, Helpers.transl("vampireIntroDesc"), Helpers.transl("vampireShortDesc"), RoleId.Vampire);
        public static RoleInfo eraser = new RoleInfo(Helpers.transl("eraser"), Eraser.color, Helpers.transl("eraserIntroDesc"), Helpers.transl("eraserShortDesc"), RoleId.Eraser);
        public static RoleInfo trickster = new RoleInfo(Helpers.transl("trickster"), Trickster.color, Helpers.transl("tricksterIntroDesc"), Helpers.transl("tricksterShortDesc"), RoleId.Trickster);
        public static RoleInfo cleaner = new RoleInfo(Helpers.transl("cleaner"), Cleaner.color, Helpers.transl("cleanerIntroDesc"), Helpers.transl("cleanerShortDesc"), RoleId.Cleaner);
        public static RoleInfo undertaker = new RoleInfo("Undertaker", Undertaker.color, Helpers.transl("cleanerIntroDesc"), "Drag up dead bodies to hide them", RoleId.Undertaker);
        public static RoleInfo warlock = new RoleInfo(Helpers.transl("warlock"), Warlock.color, Helpers.transl("warlockIntroDesc"), Helpers.transl("warlockShortDesc"), RoleId.Warlock);
